...
-- prefix 'ee', citizens 'c0', status history 'b0' -- purely for readability
-- when inspecting rows; those letters carry no semantic meaning to
-- Postgres. Grievances use the real production ID format (grievance_id_seq
-- + GrievanceIdGenerator, see schema.sql) -- G0001-G0010 are the
-- operational/demo rows, G0011-G0017 are the deliberate edge cases below.
...
INSERT INTO grievances (
    ...
    ('G0001', 'PORTAL', 'c0000000-0000-0000-0000-000000000001',
    ...
    ('G0002', 'PORTAL', 'c0000000-0000-0000-0000-000000000002',
    ...
    ('G0003', 'PORTAL', 'c0000000-0000-0000-0000-000000000003',
    ...
    ('G0004', 'PORTAL', 'c0000000-0000-0000-0000-000000000004',
    ...
    ('G0005', 'PORTAL', 'c0000000-0000-0000-0000-000000000005',
    ...
    ('G0006', 'PORTAL', 'c0000000-0000-0000-0000-000000000006',
    ...
    ('G0007', 'PORTAL', 'c0000000-0000-0000-0000-000000000001',
    ...
    ('G0008', 'PORTAL', 'c0000000-0000-0000-0000-000000000002',
    ...
    ('G0009', 'PORTAL', 'c0000000-0000-0000-0000-000000000003',
    ...
    ('G0010', 'PORTAL', 'c0000000-0000-0000-0000-000000000004',
...
-- reference 'ZZLEGACY', a department that does not exist in the departments
...
-- department was renamed/decommissioned. Deliberately NOT 'DMV' -- a real
-- DMV department was onboarded via POST /admin/departments during this
-- project's build (see PROJECT.md), so that code no longer reliably fails
-- the "does this department exist" check this edge case exists to test.
INSERT INTO grievances (
    id, channel, citizen_id, raw_text, department_predicted, department_confirmed,
    category, priority, classification_confidence, status, sla_due_at,
    assigned_department, submitted_at
) VALUES (
    'G0011', 'PORTAL', 'c0000000-0000-0000-0000-000000000005',
    'Legacy complaint about a vehicle registration issue, filed before the department was renamed.',
    'ZZLEGACY', 'ZZLEGACY', 'vehicle-registration', 'LOW', 0.6, 'ROUTED', now() - interval '200 days',
    'ZZLEGACY', now() - interval '210 days'
);
...
INSERT INTO grievances (
    ...
    'G0012', 'PORTAL', 'c0000000-0000-0000-0000-000000000006',
...
INSERT INTO grievances (
    ...
    ('G0013', 'PORTAL', 'c0000000-0000-0000-0000-000000000001',
    ...
    ('G0014', 'PORTAL', 'c0000000-0000-0000-0000-000000000002',
     ...
     'DOT', 'G0013', now() - interval '4 days'),
    ('G0015', 'PORTAL', 'c0000000-0000-0000-0000-000000000003',
...
INSERT INTO grievances (
    ...
    'G0017', 'PORTAL', 'c0000000-0000-0000-0000-000000000007',
...
INSERT INTO status_history (id, grievance_id, from_status, to_status, changed_by, changed_at, note) VALUES
    ('b0000000-0000-0000-0000-000000000001', 'G0001', NULL, 'NEW', 'system:intake', now() - interval '9 days', NULL),
    ('b0000000-0000-0000-0000-000000000002', 'G0001', 'NEW', 'TRIAGED', 'system:classifier', now() - interval '9 days', NULL),
    ('b0000000-0000-0000-0000-000000000003', 'G0001', 'TRIAGED', 'RESOLVED', 'ee000000-0000-0000-0000-000000000001', now() - interval '4 days', 'Patched within SLA.'),
    ('b0000000-0000-0000-0000-000000000004', 'G0006', 'TRIAGED', 'ESCALATED', 'ee000000-0000-0000-0000-000000000008', now() - interval '2 days', 'Jurisdiction confirmation needed for off-campus conduct.'),
    ('b0000000-0000-0000-0000-000000000005', 'G0012', 'TRIAGED', 'IN_PROGRESS', 'ee000000-0000-0000-0000-000000000001', now() - interval '44 days', 'Assigned to field crew.');
-- Note: G0012 (the stale-breach edge case) has no further history after
